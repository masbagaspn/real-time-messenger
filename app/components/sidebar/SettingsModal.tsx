            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-12">
                    <div className="border-b border-neutral-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-neutral-900">Profile</h2>
                        <p className="mt-1 text-sm leading-6 text-neutral-500">Edit your profile information.</p>
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    <Image 
                                        ...
                                        src={image || currentUser?.image || '/images/empty-avatar.jpg'}
                                        alt="Avatar"
                                    />
                                    <CldUploadButton
                                        options={{ maxFiles: 1 }}
