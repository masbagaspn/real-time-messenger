                                                ...
                                                <div className="flex items-start justify-end">
                                                    <div className="ml-3 flex h-7 items-center">
                                                        <button 
                                                            onClick={onClose}
                                                            type="button"
                                                            className="rounded-md bg-white text-neutral-400 hover:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                                                        >
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                ...
                                                <div className="w-full pt-5 pb-5 sm:px-0 sm:pt-0">
                                                    <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                        {data.isGroup && (
                                                            <div>
                                                                <dt className="text-sm font-medium text-neutral-500 sm:w-40 sm:flex-shrink-0">Emails</dt>
                                                        ...
                                                        {!data.isGroup && (
                                                            <div>
                                                                ...
                                                                <dd className="mt-1 text-sm text-neutral-900 sm:col-span-2">{otherUser.email}</dd>
                                                            </div>
                                                        )}
                                                        {!data.isGroup && (
                                                            <>
                                                                <hr />
                                                                <div>
                                                                    <dt className="text-sm font-medium text-neutral-500 sm:w-40 sm:flex-shrink-0">Joined</dt>
                                                                    <dd className="mt-1 text-sm text-neutral-900 sm:col-span-2">
